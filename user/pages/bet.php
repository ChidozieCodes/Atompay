...
<head>
    ...
    <title>AtomPay | Fund Bet Account</title>
...
<body>
    ...
    <main class="main-content">
        <div class="bet-fund-card">
            <h2>Fund Bet Account</h2>
            <p class="subtitle">Top up your betting accounts quickly and securely.</p>

            <form action="#" method="POST">
                <div class="form-group">
                    <label for="bettingPlatform">Select Betting Platform</label>
                    <select id="bettingPlatform" name="bettingPlatform" required>
                        ...
                        <!-- Add more popular platforms as needed -->
                    </select>
                </div>

                <div class="form-group">
                    <label for="bettingId">Bet Account ID / Username</label>
                    <input type="text" id="bettingId" name="bettingId" placeholder="Enter your bet account ID or username" required>
                </div>

                <div class="form-group">
                    <label for="amount">Amount (₦)</label>
                    <input type="number" id="amount" name="amount" placeholder="e.g., 1000" min="100" required>
                </div>
