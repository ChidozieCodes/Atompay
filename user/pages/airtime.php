...
<head>
    ...
    <title>AtomPay | Buy Airtime</title>
...
<body>
    ...
    <main class="main-content">
        <div class="airtime-card">
            <h2>Buy Airtime</h2>
            <p class="subtitle">Top-up your mobile phone instantly with airtime from any network.</p>
            ...
            <form action="#" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="amount" name="amount" placeholder="e.g., 1000" min="50" required>
                </div>
                
                <button type="submit" class="btn btn-primary">Buy Airtime Now</button>
            </form>
        </div>
    </main>
