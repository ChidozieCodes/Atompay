...
<head>
    ...
    <title>AtomPay | Pay Electricity</title>
...
<body>
    ...
    <main class="main-content">
        <div class="electricity-card">
            ...
            <p class="subtitle">Quickly pay your electricity bills for both prepaid and postpaid meters.</p>
            ...
            <form action="#" method="POST">
                ...
                <div class="form-group">
                    <label for="disco">Electricity Distribution Company (Disco)</label>
                    <select id="disco" name="disco" required>
                        <option value="">-- Select Disco --</option>
                        <option value="ikeja">Ikeja Electric (IKEDC)</option>
                        <option value="eko">Eko Electricity (EKEDC)</option>
                        <option value="abuja">Abuja Electricity (AEDC)</option>
                        <option value="ibadan">Ibadan Electricity (IBEDC)</option>
                        <option value="portharcourt">Port Harcourt Electricity (PHEDC)</option>
                        <option value="kano">Kano Electricity (KEDCO)</option>
                        <option value="kaduna">Kaduna Electric (KAEDC)</option>
                        <option value="jos">Jos Electricity (JEDC)</option>
                        <option value="enugu">Enugu Electricity (EEDC)</option>
                        <option value="benin">Benin Electricity (BEDC)</option>
                        <option value="yola">Yola Electricity (YEDC)</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="meterNumber">Meter Number</label>
                    <input type="text" id="meterNumber" name="meterNumber" placeholder="Enter your meter number" required>
                </div>

                <div class="form-group">
                    <label for="amount">Amount (₦)</label>
                    <input type="number" id="amount" name="amount" placeholder="e.g., 5000" min="1000" required>
                </div>
                
                <button type="submit" class="btn btn-primary">Pay Electricity Bill</button>
            </form>
        </div>
    </main>
