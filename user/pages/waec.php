...
<head>
    ...
    <title>AtomPay | Buy WAEC Pin</title>
...
<body>
    ...
    <main class="main-content">
        <div class="waec-pin-card">
            <h2>Buy WAEC/NECO Pin</h2>
            <p class="subtitle">Purchase examination scratch cards for WAEC or NECO results checking.</p>

            <form action="#" method="POST">
                <div class="form-group">
                    <label for="examType">Select Examination Type</label>
                ...
                <button type="submit" class="btn btn-primary">Buy Pin Now</button>
            </form>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const prices = {
                waec: 4800, // Example price for WAEC pin
                neco: 4600  // Example price for NECO pin
            };
            ...
            function calculateTotal() {
                ...
                if (selectedExamType && !isNaN(quantity) && quantity > 0) {
                    const unitPrice = prices[selectedExamType];
                    if (unitPrice) {
            ...
            examTypeSelect.addEventListener('change', calculateTotal);
