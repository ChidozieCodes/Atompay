...
<body>
    ...
    <main class="main-content">
        <div class="data-card">
            ...
            <p class="subtitle">Get affordable data bundles for browsing, streaming, and staying connected.</p>

            <form action="#" method="POST">
                <div class="form-group">
                    <label for="networkProvider">Select Network Provider</label>
                ...
                <div class="form-group">
                    ...
                    <select id="dataPlan" name="dataPlan" required>
                        ...
                        <optgroup label="MTN">
                            <option value="mtn-500mb-100">500MB (N100)</option>
                            <option value="mtn-1gb-250">1GB (N250)</option>
                            <option value="mtn-2gb-500">2GB (N500)</option>
                            <option value="mtn-5gb-1000">5GB (N1,000)</option>
                        </optgroup>
                        <optgroup label="Glo">
                            <option value="glo-500mb-90">500MB (N90)</option>
                            <option value="glo-1gb-200">1GB (N200)</option>
                            <option value="glo-2gb-400">2GB (N400)</option>
                        </optgroup>
                        <optgroup label="Airtel">
                            <option value="airtel-500mb-110">500MB (N110)</option>
                            <option value="airtel-1gb-280">1GB (N280)</option>
                            <option value="airtel-2gb-550">2GB (N550)</option>
                        </optgroup>
                        <optgroup label="9mobile">
                            <option value="9mobile-500mb-105">500MB (N105)</option>
                            <option value="9mobile-1gb-260">1GB (N260)</option>
                        </optgroup>
                    </select>
                </div>
                
                <button type="submit" class="btn btn-primary">Buy Data Now</button>
            </form>
        </div>
    </main>
