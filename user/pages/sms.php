    ...
    <style>
        ...
        * {
        ...
        .bulk-sms-card {
            ...
            padding: 40px;
            width: 100%;
            max-width: 650px; /* Slightly wider for message box */
            text-align: center;
            position: relative;
        }
        ...
        .form-group textarea {
            min-height: 120px; /* Ample space for messages */
            resize: vertical;
        }
...
<body>
    ...
    <main class="main-content">
        <div class="bulk-sms-card">
            <h2>Send Bulk SMS</h2>
            <p class="subtitle">Reach multiple recipients instantly with personalized messages.</p>

            <form action="#" method="POST">
                <div class="form-group">
                    <label for="senderId">Sender ID (Optional, Max 11 Chars)</label>
                    <input type="text" id="senderId" name="senderId" placeholder="e.g., AtomPay, MyBusiness" maxlength="11">
                    <small class="text-muted">This will appear as the sender of your SMS. Leave blank to use a generic ID.</small>
                </div>

                <div class="form-group">
                    <label for="recipients">Recipients (Comma separated phone numbers)</label>
                    <textarea id="recipients" name="recipients" placeholder="e.g., 08012345678, 07098765432, 09011223344" rows="4" required></textarea>
                    <small class="text-muted">Enter phone numbers separated by commas. Max 1000 numbers.</small>
                </div>

                <div class="form-group">
                    <label for="messageContent">Message Content</label>
                    <textarea id="messageContent" name="messageContent" placeholder="Type your message here..." rows="6" required></textarea>
                    <div class="char-count">
                        <span id="currentCharCount">0</span> / 160 characters per SMS
                    </div>
                </div>
