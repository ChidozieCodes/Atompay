...
<head>
    ...
    <title>AtomPay | Edit Profile</title>
    ...
    <style>
        ...
        * {
        ...
        .edit-profile-card {
            ...
            padding: 40px;
            width: 100%;
            max-width: 600px; /* Consistent width for forms */
            text-align: center;
            position: relative;
        }
...
<body>
    ...
    <header class="page-header">
        <div class="container page-navbar">
            ...
            <a href="index.html" class="page-logo">Atom<span>Pay</span></a>
        </div>
    </header>
        ...
        <div class="edit-profile-card">
            ...
            <form action="#" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phoneNumber" name="phoneNumber" value="+2348012345678" pattern="[0-9+ ]{10,15}" required>
                </div>
