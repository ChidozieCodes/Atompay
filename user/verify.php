...
<head>
    ...
    <title>AtomPay | Verify Code</title>
...
<body>
    ...
    <main class="main-content">
        <div class="verify-code-card">
            ...
            <p class="subtitle">A 6-digit code has been sent to your registered phone number. Please enter it below to proceed.</p>

            <form action="#" method="POST">
                <div class="form-group">
                    <label for="otpCode" class="sr-only">Verification Code</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const verifyBtn = document.querySelector('.verify-code-card .btn-primary');
            ...
            verifyBtn.addEventListener('click', (event) => {
                ...
                if (otp.length === 6 && /^\d+$/.test(otp)) {
                    ...
                    alert(`Verifying code: ${otp}. Verification successful!`);
                    // Redirect to the appropriate page (e.g., dashboard, or continue login)
